...
await paperspace.fill('input[type="email"]', 'chaowen.guo1@gmail.com')
await paperspace.fill('input[type="password"]', process.argv.at(2))
await globalThis.Promise.all([paperspace.waitForNavigation(), paperspace.click('button.c-jpjkst.c-jpjkst-kkVNWy-variant-cta')])
await paperspace.goto('https://console.paperspace.com/chaowenguo/notebook/ru6b8i1y7u2vu0w?file=%2Fpal.ipynb')
